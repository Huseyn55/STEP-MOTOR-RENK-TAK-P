    ...
    public partial class Form1 : Form
    {
        ...
        private void pccam_NewFrame(object sender, NewFrameEventArgs eventArgs)
        {
            ...
            if (radioButton2.Checked)
            {
                ...
                filter.CenterColor = new RGB(Color.FromArgb(170, 30, 30)); // Algılanacak Renk ve merkez noktası bulunur.
                filter.Radius = 50;
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialog = swf.ShowDialog();  //Resmi çekiyoruz ve kaydediyoruz.
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (pccam.IsRunning)
            {
                pccam.Stop(); // Kamerayı durduruyoruz.
